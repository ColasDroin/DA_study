...
on_x1        = [250, 255, 260, 265, 270, 275, 280, 285, 290, 295]
on_x8v       = 170
on_x8h       = 0.0
on_disp      = 1
chroma       = 15

study_name = f"opt_flathv_75_1500_withBB_chroma15_octphi2"

children={}
children[study_name] = {}
children[study_name]["children"] = {}

for optics_job, (myq1, my_optics, my_sigt, my_npart, my_oct, my_crabs, my_on_x1) in enumerate(itertools.product(qx0, optics_file, beam_sigt, beam_npart, oct_current, enable_crabs, on_x1)):
    optics_children={}
